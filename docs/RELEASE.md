...
| :---: | :--- | :--- | :--- |
| 1 | `debug_kit` | 0.8.0 | Core — publish first, no local deps |
...
- The published `pubspec.yaml` uses a proper hosted version constraint (`^0.8.0` for `debug_kit`, `^0.4.0` for `debug_kit_dio`), not a `path:` dependency.
