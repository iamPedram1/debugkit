...
| :---: | :--- | :--- | :--- |
| 1 | `debug_kit` | 0.5.2 | Core — publish first, no local deps |
...
- The published `pubspec.yaml` uses a proper hosted version constraint (`^0.2.1`), not a `path:` dependency.
...
```bash
git tag debug_kit-v0.2.1
git tag debug_kit_dio-v0.1.0
